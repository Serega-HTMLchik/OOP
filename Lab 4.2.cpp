...
int main() {
    ...
    cout << "Start date of construction: " << start << endl;
    cout << "Construction time: " << constructing << endl;
    cout << "Date of facility handover(Date+Date): " << end << endl;
    end = start - constructing;
    cout << "Start date of construction of the facility(Date-Date): " << end << endl;
    end = start + 29;
    cout << "Date of object delivery(Date+Int): " << end << endl;
    end = end - 29;
    cout << "Start date of construction of the facility(Date-Int): " << end << endl;
    end = start++;
    cout << "Date of delivery of the facility(Date++): " << end << endl;
    end = end--;
    cout << "The start date of construction of the facility(Date--): " << end << endl;
    return 0;
}
